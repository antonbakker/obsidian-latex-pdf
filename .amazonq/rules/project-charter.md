...
- IMPLEMENTED: Basic template registry, More options menu integration, and print modal UI wired to either a direct pandoc runner or the existing Pandoc plugin.
